...
- table [ref=e3]:
  - rowgroup [ref=e4]:
    ...
    - 'row "1 0.0001 448720 {main}( ) ...\\reports.php:0" [ref=e17]':
      - cell "1" [ref=e18]
      - cell "0.0001" [ref=e19]
      - cell "448720" [ref=e20]
      - 'cell "{main}( )" [ref=e21]'
      - cell "...\\reports.php:0" [ref=e22]
    - row "2 0.0064 589232 getReportSummary( $fromDate = '2026-06-25', $toDate = '2026-07-25' ) ...\\reports.php:18" [ref=e23]:
      - cell "2" [ref=e24]
      - cell "0.0064" [ref=e25]
      - cell "589232" [ref=e26]
      - cell "getReportSummary( $fromDate = '2026-06-25', $toDate = '2026-07-25' )" [ref=e27]
      - cell "...\\reports.php:18" [ref=e28]
    - row "3 0.0064 589688 prepare( $query = 'SELECT COUNT(*) as total_events FROM events WHERE 1=1 AND event_date >= ? AND event_date <= ?' ) ...\\report_engine.php:88" [ref=e29]:
      - cell "3" [ref=e30]
      - cell "0.0064" [ref=e31]
      - cell "589688" [ref=e32]
